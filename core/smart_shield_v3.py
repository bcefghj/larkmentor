    ...
    *,
    ...
    if verdict.action is Action.BLOCK:
        audit(
            ...
            outcome="deny",
            severity="HIGH",
            meta={"reason": "prompt_injection_block", "tags": ",".join(verdict.tags)},
        )
        decision = {
            "level": "P3",
            "action": "archive",
            ...
            "score": 0.0,
            "dimensions": {},
            "explanation": "blocked by transcript classifier",
    ...
    if verdict.action is Action.REDACT:
        ...
        audit(
            ...
            outcome="allow",
            severity="WARN",
            meta={"reason": "prompt_injection_redact", "tags": ",".join(verdict.tags)},
        )
    ...
    if forced and forced != result.get("level"):
        audit(
            ...
            outcome="allow",
            severity="INFO",
            meta={"reason": "hook_force_level", "from": str(result.get("level")), "to": forced},
        )
        result["level"] = forced
